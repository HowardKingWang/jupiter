...
public class MonkeyLearnClient {
	...
	private static final String API_KEY = "3f102e04e5b986e27e9761977fb96bd317fdfee2";// make sure change it to my own api key.
	...
	public static List<List<String>> extractKeywords(String[] text) {
		...
		try {
			response = ml.extractors.extract("ex_YCya9nrn", text, extraParams);//change to my own model id
